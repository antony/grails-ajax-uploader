...
qq.FileUploaderBasic = function (o) {
    ...
    this._options = {
        ...
        messages: {
            ...
            sizeError: "Unable to complete upload as the file ({file}) exceeds the size limit of {sizeLimit}. Current file size is {currentFileSize}",
...
qq.FileUploaderBasic.prototype = {
    ...
    _error: function (code, fileName, fileSize) {
        ...
        if (fileSize !== null && fileSize !== undefined) {
            r('{currentFileSize}', this._formatSize(fileSize));
        }
