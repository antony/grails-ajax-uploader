...
import uk.co.desirableobjects.ajaxuploader.AjaxUploaderTagLib
...
class AjaxUploaderTagLibSpec extends Specification implements TagLibUnitTest<AjaxUploaderTagLib> {
